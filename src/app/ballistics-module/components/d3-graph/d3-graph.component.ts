...
export class D3GraphComponent implements OnInit, OnChanges {
    ...
    */
    ...
    @Input() xToFixed: number = Infinity;
    @Input() yToFixed: number = Infinity;
    ...
    createBarGraph(): void {
        ...
        svg.selectAll('rect').data(_this.data).enter().append('rect')
            ...
            .on('mouseover', function(d: any) {
                ...
                let tip = `<strong>${_this.xKey}:</strong> ${_this.getValue(d[_this.xKey], _this.xToFixed)}<br/><strong>${_this.yKey}:</strong> ${_this.getValue(d[_this.yKey], _this.yToFixed)}<br/>`;
