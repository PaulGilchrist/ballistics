...
export class DragService {
    ...
    ingalsSpaceFromVelocity(currentVelocity: number) {
        ...
        if(INGALS.v[counter] == currentVelocity) {
          ...
          //Interoperlate Array
          var differenceBetweenVelocityIndexes = INGALS.v[counter - 1] - INGALS.v[counter];
          var distanceFromVelocityIndex = currentVelocity - INGALS.v[counter];
          var differenceBetweenSpaceIndexes = INGALS.s[counter] - INGALS.s[counter - 1];
	...
	ingalsTimeFromVelocity(currentVelocity: number) {
        ...
        if(INGALS.v[counter] == currentVelocity) {
          ...
          var differenceBetweenVelocityIndexes = INGALS.v[counter - 1] - INGALS.v[counter];
          var distanceFromVelocityIndex = currentVelocity - INGALS.v[counter];
          var differenceBetweenTimeIndexes = INGALS.t[counter] - INGALS.t[counter - 1];
          var percentage = distanceFromVelocityIndex / differenceBetweenVelocityIndexes;
    ...
    ingalsVelocityFromSpace(currentSpace: number) {
        ...
        if(INGALS.s[counter] == currentSpace) {
          ...
          //Interoperlate Array
          var differenceBetweenSpaceIndexes = INGALS.s[counter] - INGALS.s[counter - 1];
          var distanceFromSpaceIndex = INGALS.s[counter] - currentSpace;
          var differenceBetweenVelocityIndexes = INGALS.v[counter - 1] - INGALS.v[counter];
    ...
    ingalsVelocityFromTime(currentTime: number) {
        ...
        if(INGALS.t[counter] == currentTime) {
          ...
          //Interoperlate Array
          var differenceBetweenTimeIndexes = INGALS.t[counter] - INGALS.t[counter - 1];
          var distanceFromTimeIndex = INGALS.t[counter] - currentTime;
          var differenceBetweenVelocityIndexes = INGALS.v[counter - 1] - INGALS.v[counter];
